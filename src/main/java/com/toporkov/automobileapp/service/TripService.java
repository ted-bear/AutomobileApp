...
public class TripService {
    ...
    public List<Trip> findAllByInterval(final Instant startedAt,
                                        final Instant endedAt) {
        return tripRepository.findAllByStartedAtAfterAndEndedAtBefore(startedAt, endedAt);
    }

    public List<TripDTO> findTripsBetween(final Integer vehicleId,
    ...
    private TripDTO mapEntityToDTO(final Trip trip,
